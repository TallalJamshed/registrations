                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input disabled type="text" id="sc_br_name" name="sc_br_name" class="disable_on_sc_id form-control form-control-alternative" 
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input disabled type="text" id="sc_br_address" name="sc_br_address" class="disable_on_sc_id form-control form-control-alternative" 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <select disabled class="disable_on_sc_id form-control form-control-alternative sc_br_status" id="sc_br_status" name="sc_br_status">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input disabled type="text" id="no_of_boys" name="no_of_boys" class="disable_on_sc_id form-control form-control-alternative" 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input disabled type="text" id="no_of_girls" name="no_of_girls" class="disable_on_sc_id form-control form-control-alternative" 
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input disabled type="text" id="sc_br_covered_area" name="sc_br_covered_area" class="disable_on_sc_id form-control form-control-alternative" 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input disabled type="text" id="no_of_teachers" name="no_of_teachers" class="disable_on_sc_id form-control form-control-alternative" 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input disabled type="text" id="owner_name" name="owner_name" class="disable_on_sc_id form-control form-control-alternative" 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                <input disabled type="text" id="owner_phone" name="owner_phone" class="disable_on_sc_id form-control form-control-alternative" 
                    ...
                    <div class="row mt-5">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input disabled type="text" id="owner_email" name="owner_email" class="disable_on_sc_id form-control form-control-alternative" 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input disabled type="text" id="principal_name" name="principal_name" class="disable_on_sc_id form-control form-control-alternative" 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                <input disabled type="text" id="principal_phone" name="principal_phone" class="disable_on_sc_id form-control form-control-alternative" 
                    ...
                    <div class="row mt-5">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <input disabled type="text" id="principal_email" name="principal_email" class="disable_on_sc_id form-control form-control-alternative" 

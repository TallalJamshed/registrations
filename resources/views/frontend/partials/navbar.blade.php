<nav class="navbar navbar-default">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('home')}}"> <img src="{{asset('img/RegistrationLogo.png')}}"></a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="{{route('regschool')}}">School Registration</a></li>
                      <li><a href="{{route('regngo')}}">NGO Registration</a></li>
